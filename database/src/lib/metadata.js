...
export default class Metadata {
    ...
    async #findOrInsertSongArtistAlbumTxact({ song, trackInfo, songArtists, album, albumArtists }, sqlTxact) {
        ...
        // If haven't found album, create one when album is specified
            ...
            outAlbum = await this.#findOrInsertAlbum({ album, albumArtists: albumArtists ?? songArtists }, sqlTxact)
    ...
    async #findOrInsertSong({ song, songArtists }, sqlTxact) {
        ...
        // Then insert song, and insert into artist_songs
            ...
            // Insert artists
            const artists = await this.#findOrInsertArtists(songArtists, sqlTxact)
    ...
    // Internal function, with transaction context
    // NOT CONCURRENTLY SAFE
    async #findOrInsertAlbum({ album, albumArtists }, sqlTxact) {
        ...
        // Then insert album, and insert into artist_albums
            ...
            // Insert artists
            const artists = await this.#findOrInsertArtists(albumArtists, sqlTxact)
    ...
    // Internal function, with transaction context
    // NOT CONCURRENTLY SAFE
    async #findOrInsertArtists(artists, sqlTxact) {
        try {
